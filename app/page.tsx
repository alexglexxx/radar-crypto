        ...
        <div style={{display:'grid', gridTemplateColumns:'1.2fr 0.8fr', gap:8}}>
          <div style={{background:'#101010', border:'1px solid #222', borderRadius:12, padding:12}}>
            ...
            <div style={{display:'flex', gap:6, fontSize:8, marginBottom:6}}>
              <span><span style={{width:8,height:8, background:'#ef4444', display:'inline-block'}}></span> 0-44 NO</span>
              <span><span style={{width:8,height:8, background:'#eab308', display:'inline-block'}}></span> 45-69 ESPERA</span>
              <span><span style={{width:8,height:8, background:'#22c55e', display:'inline-block'}}></span> 70-100 COMPRA</span>
            </div>
            ...
            {sel && (
              <div style={{marginTop:10, background:'#000', border:'1px solid #222', borderRadius:8, padding:8}}>
                ...
                <div style={{fontSize:10, color:'#aaa', marginTop:4, lineHeight:'13px'}}>
                  {sel.score>=70
                   ? 'Score '+sel.score+' VERDE = buen momento. Si ves muchas barras verdes arriba de la linea punteada (70), es tendencia fuerte para COMPRAR.'
                    : sel.score>=45
                   ? 'Score '+sel.score+' AMARILLO = esperar. Cuando barras crucen la linea verde de 70, sera momento.'
                    : 'Score '+sel.score+' ROJO = no comprar ahora.'}
                </div>
                <div style={{fontSize:8, color:'#555', marginTop:6}}>Linea punteada = 70 zona compra | {history.length} lecturas</div>
